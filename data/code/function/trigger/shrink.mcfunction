...
execute if score @s shrink matches 2..24 run tellraw @s {text:"Scale has a limit of 0.25 to 1.0!",color:"red"}
execute if score @s shrink matches 2..24 run scoreboard players set @s shrink 25
execute if score @s shrink matches 101.. run tellraw @s {text:"Scale has a limit of 0.25 to 1.0!",color:"red"}
